...
export default function DriverForm({ isOpen, onClose, onSuccess }: DriverFormProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* License URL */}
          <div className="space-y-2">
            <label className="text-sm font-medium">License Document URL</label>
            <Input
          ...
          {/* Aadhar URL */}
          <div className="space-y-2">
            <label className="text-sm font-medium">Aadhar Document URL</label>
            <Input
          ...
          {/* PAN URL */}
          <div className="space-y-2">
            <label className="text-sm font-medium">PAN Document URL</label>
            <Input
              value={formData.pan}
